...
(cl:defmethod cl:initialize-instance :after ((m <IMU>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sirius2std-msg:<IMU> is deprecated: use sirius2std-msg:IMU instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:header-val is deprecated.  Use sirius2std-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:status-val is deprecated.  Use sirius2std-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:time-val is deprecated.  Use sirius2std-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'ax-val :lambda-list '(m))
(cl:defmethod ax-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:ax-val is deprecated.  Use sirius2std-msg:ax instead.")
  (ax m))

(cl:ensure-generic-function 'ay-val :lambda-list '(m))
(cl:defmethod ay-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:ay-val is deprecated.  Use sirius2std-msg:ay instead.")
  (ay m))

(cl:ensure-generic-function 'az-val :lambda-list '(m))
(cl:defmethod az-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:az-val is deprecated.  Use sirius2std-msg:az instead.")
  (az m))

(cl:ensure-generic-function 'yaw_rate-val :lambda-list '(m))
(cl:defmethod yaw_rate-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:yaw_rate-val is deprecated.  Use sirius2std-msg:yaw_rate instead.")
  (yaw_rate m))

(cl:ensure-generic-function 'pitch_rate-val :lambda-list '(m))
(cl:defmethod pitch_rate-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:pitch_rate-val is deprecated.  Use sirius2std-msg:pitch_rate instead.")
  (pitch_rate m))

(cl:ensure-generic-function 'roll_rate-val :lambda-list '(m))
(cl:defmethod roll_rate-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:roll_rate-val is deprecated.  Use sirius2std-msg:roll_rate instead.")
  (roll_rate m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sirius2std-msg:temperature-val is deprecated.  Use sirius2std-msg:temperature instead.")
  (temperature m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IMU>)))
  ...
  "3b5ae2af5aa10b2a3ae3a86603eba3d5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IMU)))
  "Returns md5sum for a message object of type 'IMU"
  "3b5ae2af5aa10b2a3ae3a86603eba3d5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IMU>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%uint32  status      # 0: normal, > 0: error~%float64 time        # the synchronized local system time (local time + offset) in ms~%float64 ax          # m/s/s~%float64 ay          # m/s/s~%float64 az          # m/s/s~%float64 yaw_rate    # rad/s~%float64 pitch_rate  # rad/s~%float64 roll_rate   # rad/s~%float64 temperature # Centigrade~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IMU)))
  "Returns full string definition for message of type 'IMU"
  (cl:format cl:nil "std_msgs/Header header~%uint32  status      # 0: normal, > 0: error~%float64 time        # the synchronized local system time (local time + offset) in ms~%float64 ax          # m/s/s~%float64 ay          # m/s/s~%float64 az          # m/s/s~%float64 yaw_rate    # rad/s~%float64 pitch_rate  # rad/s~%float64 roll_rate   # rad/s~%float64 temperature # Centigrade~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
